...
/**
 *
 * Classe Criada para Funcionamento do JogoSinglePLayer
 */
public class Engine {
     /*
    Default Constructor
    ...
    */ 
    public Engine(Canhao c, int Level, Integer Pontuacao){
        this.C = c; //Aponta para o canhao criado no Jogo
    ...
    private boolean CanhaoEliminado; //Caso jogador tome tiro
    ...
    Image MorteCanhao = new Image( "Imagens/canhaoMorte.png" );//Seta imagens
    ...
    */
    public int RodaJogo(GraphicsContext gc){
        ...
        {    
            ...
            {    
                CanhaoEliminado=false;
                C.setImage(ImgCanhao);
        ...
        {  
            ...
            gc.fillText( "Vidas:" , 500, 25 );
            gc.fillText( "Space Invaders Eng Comp Edition" , 850, 25 );
           ...
           //Desenha miniVidas
            ...
            for (Nave nave : Enemys.Naves) { 
                C.VerificaColisaoNave(nave); //Verifica Colisao Canhao/Naves
            }
    ...
    public void verificaTiroCanhao(Canhao C,GraphicsContext gc){
        ...
        {    
            ...
            {    
                ...
                if(C.TiroCanhao.getY()>5) //Movimenta Tiro
                    C.TiroCanhao.avanca(10);
    ...
    */ 
     public boolean verificaTiroInimigo(Tiro T,GraphicsContext gc){
        ...
        {    
                ...
                if(C.VerificaTiro(T))  //Verifica colisao Tiro/Canhao
                {    
                   this.AcertouCanhao(T, gc);
    ...
    */ 
    public void AcertouCanhao(Tiro T,GraphicsContext gc)
    {
        ...
        CanhaoEliminado=true; //Seta boolean de eliminado para true
